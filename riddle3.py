...
for i in list(range(3,len(s)-3)):
    if ord(s[i])>96 and ord(s[i])<123:
        if ord(s[i-1])>64 and ord(s[i-1])<91 and ord(s[i-2])>64 and ord(s[i-2])<91 and ord(s[i-3])>64 and ord(s[i-3])<91 and ord(s[i+1])>64 and ord(s[i+1])<91 and ord(s[i+2])>64 and ord(s[i+2])<91 and ord(s[i+3])>64 and ord(s[i+3])<91:
            if ord(s[i-4])>90 and ord(s[i+4])>90:
                print(s[i])
